            ...
            <div>
              ...
              <div className="col-sm-5 searchbar">
                <div className="searchTour">
                  <span className='black'>Province</span>
          ...
          <div className=" gridResize bgsearch ">
            ...
            <div>
              ...
              <div className="col-sm-2 searchbar">
                <div className="searchTour">
                  <span className='black'>Province</span>
                   <select onChange={this.setRedirectCity} value={this.props.city} className="form-control">
                          {
                            city.map((value , index) => {
                              return(
                                  <option  key={index} value={value}>{value}</option>
              ...
              <div className="col-sm-2 searchbar">
                <div className="searchTour">
                  <span className='black'>Category</span>
